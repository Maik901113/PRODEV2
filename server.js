            ...
            app.route('/generacion_ticket')
              ...
              //mantenimiento//
              app.set('view engine', 'ejs'); // Ajusta según tu motor de plantillas (en este caso, EJS)

              app.use('/mantenimiento', express.static(path.join(__dirname, 'views')));

            
              const mantenimientoRoutes = require('./routes/mantenimientoRoutes'); // Ajusta la ruta según tu estructura
